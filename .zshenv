...
export FZF_DEFAULT_OPTS="--style=minimal --ansi --tabstop=1 --no-sort --delimiter=\\t --nth=-1 --accept-nth=-1 --preview='if [ -d {-1} ]; then ls -1 --color=always {-1}; else bat --color=always --style=numbers --line-range=:500 {-1}; fi' --bind=ctrl-d:preview-half-page-down,ctrl-u:preview-half-page-up"
