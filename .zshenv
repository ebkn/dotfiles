...
export FZF_DEFAULT_OPTS="--style=minimal --ansi --tabstop=1 --delimiter=\\t --nth=-1 --accept-nth=-1 --preview='bat --color=always --style=numbers --line-range=:500 {-1}' --bind=ctrl-d:preview-half-page-down,ctrl-u:preview-half-page-up"
